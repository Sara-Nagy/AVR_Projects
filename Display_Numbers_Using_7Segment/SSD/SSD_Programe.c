...
{
  DIO_VoidSetPinDirection(u8cpy_portindex,DIO_PIN0,DIO_OUT);//a
  DIO_VoidSetPinDirection(u8cpy_portindex,DIO_PIN1,DIO_OUT);//b
  DIO_VoidSetPinDirection(u8cpy_portindex,DIO_PIN2,DIO_OUT);//c
  DIO_VoidSetPinDirection(u8cpy_portindex,DIO_PIN3,DIO_OUT);//d
  DIO_VoidSetPinDirection(u8cpy_portindex,DIO_PIN4,DIO_OUT);//e
  DIO_VoidSetPinDirection(u8cpy_portindex,DIO_PIN5,DIO_OUT);//f
  DIO_VoidSetPinDirection(u8cpy_portindex,DIO_PIN6,DIO_OUT); //g
}


void SSD_VoidBCDInit(u8 u8cpy_portindex)
{   
	#if BCD_MODE == LOW_NIBLLE
