...
{
	//1_select fast PWM mode (at ICR1 is the top not TCNT1)
	CLR_BIT(TCCR1A,WGM10);
	SET_BIT(TCCR1A,WGM11);
	SET_BIT(TCCR1B,WGM12);
	SET_BIT(TCCR1B,WGM13);
	//2_load a value in OCR1A 
	OCR1A=f32copy_time*1000; //f32copy_time in ms 
	//3_load a value in ICR1 
	ICR1=19999;
	//4_select timer clock(prescaler =8)
	TCCR1B=(TCCR1B & 0b11111000)|TIMER1_CLOCK;
	//5_Clear OC1A/OC1B on compare match, set OC1A/OC1B at TOP
